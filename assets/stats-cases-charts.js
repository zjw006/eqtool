  ...
  function initSamplingChart() {
    ...
    charts.sampling.setOption({
      ...
      xAxis: Object.assign({
        ...
        axisLabel: { color: '#9B8B7A', fontSize: 11, interval: 0 },
      ...
      series: [
        ...
        },
        {
          ...
          data: [22, 20, 23],
          itemStyle: { color: '#E8A93E', borderRadius: [4, 4, 0, 0] },
          label: { show: true, position: 'top', color: '#E8A93E', fontWeight: 'bold', fontSize: 12 }
        }
      ]
    });
  }
  ...
  function initDistributionChart() {
    ...
    charts.distribution.setOption({
      ...
      xAxis: Object.assign({
        type: 'category',
        data: scores,
        axisLabel: { color: '#9B8B7A', fontSize: 13 },
        splitLine: { show: false }
      }, axisStyle()),
      yAxis: Object.assign({
        type: 'value',
    ...
    charts.regression.setOption({
      ...
      series: [
        ...
        },
        {
          ...
          symbolSize: 14,
          itemStyle: { color: '#E8A93E', borderColor: '#fff', borderWidth: 2 },
          label: {
            show: true, position: 'top',
            color: '#E8A93E', fontWeight: 'bold', fontSize: 12,
  ...
  function initNormalChart(mu, sigma) {
    ...
    charts.normal.setOption({
      ...
      legend: {
        ...
        top: 28, textStyle: { color: '#9B8B7A', fontSize: 11 },
  ...
  function initRecommendChart() {
    ...
    chart.setOption({
      ...
      series: [{
        ...
        label: { color: '#4A3B2E', fontSize: 12, fontFamily: 'Outfit, system-ui, sans-serif' },
        itemStyle: { borderWidth: 0 },
        data: [
          { name: '\u7528\u6237\u884c\u4e3a\u6570\u636e', itemStyle: { color: '#10b981' } },
          { name: '\u6d4f\u89c8/\u70b9\u51fb/\u505c\u7559', itemStyle: { color: '#06b6d4' } },
          { name: '\u7528\u6237-\u7269\u54c1\u77e9\u9635', itemStyle: { color: '#06b6d4' } },
          { name: '\u76f8\u4f3c\u5ea6\u8ba1\u7b97', itemStyle: { color: '#E8A93E' } },
          { name: '\u76f8\u5173\u7cfb\u6570', itemStyle: { color: '#E8A93E' } },
          { name: '\u6761\u4ef6\u6982\u7387\u4f30\u8ba1', itemStyle: { color: '#ec4899' } },
          { name: 'P(\u559c\u6b22|\u5386\u53f2)', itemStyle: { color: '#ec4899' } },
          { name: '\u6392\u5e8f\u5019\u9009', itemStyle: { color: '#B89AD9' } },
          { name: 'A/B\u6d4b\u8bd5', itemStyle: { color: '#B89AD9' } },
          { name: '\u72ec\u7acb\u6027\u68c0\u9a8c', itemStyle: { color: '#B89AD9' } },
